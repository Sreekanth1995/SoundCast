...
//  KarHappy
//
//  Created by M sreekanth  on 27/07/18.
...
class Pulsing: CALayer {
    ...
    init(numberOfPulses:Float = Float.infinity, radius:CGFloat, position:CGPoint) {
        ...
        super.init()
        self.backgroundColor = UIColor.appThemeColor().cgColor
        ...
        self.bounds = CGRect.init(x: 0, y: 0, width: radius * 2, height: radius * 2)
    ...
    func setupAnimationGroup(){
        ...
        animationGroup.repeatCount = self.numberOfPulses
